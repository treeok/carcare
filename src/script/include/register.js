...
define(['widget/dialog','widget/utils'],function(Dialog,Utils){
    var _body = '<div  id="popup_register_container">\
            ...
            if(singleRegister){
                ...
                singleRegister = new Dialog({
                    ...
                    afterRender:function(){
                        $('#popup_register_container').on('focus','input',function(){
                        ...
                        function sendPhoneCode(){
                            if($.trim(useNameCon.val())==''){
                                useNameCon.next().show();
                                return false;
                            }
                            if(!useNameCon.val().match(/^1[3|4|5|7|8][0-9]\d{8}$/)){
                                useNameCon.next().next().show();
                                return false;
                            }

                            sendCodeBtn.attr('disabled',true);
                            sendCodeBtn.val('60秒后点击再次发送');
